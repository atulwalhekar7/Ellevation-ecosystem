...
/* ─── Page ──────────────────────────────────────────────────────────────── */
export default function EllevationEventPage() {
  ...
  return (
    <div className="hub-event-root" style={ev.root}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        input:focus, select:focus, textarea:focus {
          ...
          box-shadow: 0 0 0 3px rgba(90,64,112,0.1);
          outline: none;
        }
        ...
        /* ── Dark Mode Overrides ── */
        [data-theme="dark"] .hub-event-root { background: #0a0614 !important; color: #e8e0f8 !important; }
        [data-theme="dark"] .hub-event-hero-eyebrow { color: #b4a0d0 !important; }
        [data-theme="dark"] .hub-event-info-strip { background: #1a1030 !important; border-color: rgba(180,160,208,0.15) !important; }
        [data-theme="dark"] .hub-event-info-label { color: #8f79ad !important; }
        [data-theme="dark"] .hub-event-info-value { color: #e8e0f8 !important; }
        [data-theme="dark"] .hub-event-section-title { color: #e8e0f8 !important; }
        [data-theme="dark"] .hub-event-section-eye { color: #b4a0d0 !important; }
        [data-theme="dark"] .hub-event-highlight-card { background: #1a1030 !important; border-color: rgba(180,160,208,0.15) !important; }
        [data-theme="dark"] .hub-event-highlight-title { color: #e8e0f8 !important; }
        [data-theme="dark"] .hub-event-highlight-text { color: #b4a0d0 !important; }
        [data-theme="dark"] .hub-event-timeline-title { color: #e8e0f8 !important; }
        [data-theme="dark"] .hub-event-timeline-detail { color: #b4a0d0 !important; }
        [data-theme="dark"] .hub-event-timeline-time { color: #8f79ad !important; }
        [data-theme="dark"] .hub-event-timeline-line { background: rgba(180,160,208,0.2) !important; }
        [data-theme="dark"] .hub-event-form-card { background: #1a1030 !important; box-shadow: 0 10px 48px rgba(0,0,0,0.5) !important; }
        [data-theme="dark"] .hub-event-form-intro { color: #b4a0d0 !important; }
        [data-theme="dark"] .hub-event-input { background: #0a0614 !important; border-color: rgba(180,160,208,0.25) !important; color: #e8e0f8 !important; }
        [data-theme="dark"] .hub-event-input::placeholder { color: rgba(232,224,248,0.35) !important; }
        [data-theme="dark"] .hub-event-agree-text { color: #b4a0d0 !important; }
      `}</style>

      {/* ── HERO ── */}
      <section style={ev.hero}>
        ...
        <div className="hub-event-hero-content" style={ev.heroContent}>
          <div style={ev.eyebrowRow}>
            <span style={ev.eyebrowLine} />
            <span className="hub-event-hero-eyebrow" style={ev.eyebrowText}>
              ELLEVATION HUB PRESENTS
            </span>
            <span style={ev.eyebrowLine} />
          </div>
      ...
      <section style={ev.section}>
        <div style={ev.sectionEyebrowRow}>
          <span style={ev.eyebrowLine} />
          <span className="hub-event-section-eye" style={ev.eyebrowText}>WHAT TO EXPECT</span>
          <span style={ev.eyebrowLine} />
        </div>
      ...
      <section style={{ ...ev.section, background: "#f8f6fc" }}>
        <div style={ev.sectionEyebrowRow}>
          <span style={ev.eyebrowLine} />
          <span className="hub-event-section-eye" style={ev.eyebrowText}>RUN OF SHOW</span>
          <span style={ev.eyebrowLine} />
        </div>
        <h2 className="hub-event-section-title" style={ev.sectionTitle}>
      ...
      <section id="rsvp" style={ev.formSection}>
        <div style={{ maxWidth: 640, margin: "0 auto", width: "100%" }}>
          <div style={ev.sectionEyebrowRow}>
            <span style={ev.eyebrowLine} />
            <span className="hub-event-section-eye" style={ev.eyebrowText}>RSVP</span>
            <span style={ev.eyebrowLine} />
          </div>
...
/* ─── Styles — matched to Ellevation Hub's design tokens ───────────────────
   Fonts: 'Cormorant Garamond' (display) + 'DM Sans' (body/UI)
   Palette: #1a0a2e (navy ink), #5a4070 (deep purple), #b4a0d0 (lavender),
            #9b7db8 (mid purple), #f8f6fc (soft bg), #ede8f5 (hairline border)
─────────────────────────────────────────────────────────────────────────── */
const NAVY = "#1a0a2e";
...
const ev: Record<string, React.CSSProperties> = {
  ...
  heroOverlay: {
    position: "absolute",
    inset: 0,
    background: "linear-gradient(160deg, #1a0a2e 0%, #26123f 55%, #1a0a2e 100%)",
    zIndex: 0,
  },
  heroBlobTL: {
    position: "absolute", top: -100, left: -80, width: 420, height: 420,
    borderRadius: "50%",
    background: "radial-gradient(circle, rgba(155,125,184,0.25) 0%, transparent 70%)",
    animation: "floatBlob 10s ease-in-out infinite", zIndex: 1,
  },
  heroBlobBR: {
    position: "absolute", bottom: -100, right: -70, width: 380, height: 380,
    borderRadius: "50%",
    background: "radial-gradient(circle, rgba(90,64,112,0.3) 0%, transparent 70%)",
    animation: "floatBlob 13s ease-in-out infinite reverse", zIndex: 1,
  },
  ...
  eyebrowLine: { display: "inline-block", width: 40, height: 1, background: "rgba(255,255,255,0.35)" },
  eyebrowText: {
    fontFamily: "'DM Sans', sans-serif", fontSize: 12, fontWeight: 700,
    letterSpacing: "0.22em", color: "#b4a0d0",
  },
  heroTitle: {
    fontFamily: "'Cormorant Garamond', serif",
    fontSize: "clamp(2.8rem, 6vw, 4.6rem)",
    fontWeight: 500, color: "#fff",
    lineHeight: 1.08, marginBottom: 18, letterSpacing: "-0.01em",
  },
  heroSub: {
    fontFamily: "'DM Sans', sans-serif", fontSize: "1rem", fontWeight: 300,
    color: "rgba(255,255,255,0.8)", lineHeight: 1.75, maxWidth: 520, margin: "0 auto",
  },
  ...
  infoCard: {
    ...
    background: "#fff", border: "1px solid #ede8f5", borderRadius: 16,
    padding: "20px 22px", boxShadow: "0 8px 32px rgba(26,10,46,0.08)",
  },
  infoLabel: {
    fontFamily: "'DM Sans', sans-serif", fontSize: 10, fontWeight: 700,
    letterSpacing: "0.16em", color: "#b4a0d0",
  },
  infoValue: {
  ...
  // SECTION SHARED
  section: { padding: "96px 48px 80px", background: "#fff", textAlign: "center" },
  sectionEyebrowRow: {
    display: "flex", alignItems: "center", justifyContent: "center",
  ...
  highlightCard: {
    background: "#f8f6fc", border: "1px solid #ede8f5", borderRadius: 18,
  ...
  timelineTime: {
    ...
    letterSpacing: "0.04em", color: "#9b7db8", whiteSpace: "nowrap",
  },
  ...
  timelineTitle: {
    fontFamily: "'Cormorant Garamond', serif", fontSize: "1.2rem",
    fontWeight: 600, color: NAVY, marginBottom: 4,
  },
  timelineDetail: {
    fontFamily: "'DM Sans', sans-serif", fontSize: "0.86rem", fontWeight: 300,
    color: "#5a4070", lineHeight: 1.6,
  },

  // FORM
  formSection: {
    padding: "96px 24px 120px", background: "#fff",
    display: "flex", justifyContent: "center", textAlign: "center",
  },
  formIntro: {
    fontFamily: "'DM Sans', sans-serif", fontSize: "0.92rem", fontWeight: 300,
    color: "#5a4070", maxWidth: 460, margin: "0 auto 36px", lineHeight: 1.6,
  },
  formCard: {
    background: "#fff", borderRadius: 22, padding: "44px 40px",
    boxShadow: "0 10px 40px rgba(26,10,46,0.08)",
    border: "1px solid #ede8f5", textAlign: "left",
  },
  row: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 },
  fieldWrap: { display: "flex", flexDirection: "column", marginBottom: 16 },
  input: {
    width: "100%", fontFamily: "'DM Sans', sans-serif", fontSize: "0.9rem",
    padding: "13px 16px", borderRadius: 12, border: "1px solid #ede8f5",
    background: "#fcfaff", color: NAVY, transition: "all 0.2s ease",
  },
  inputError: { borderColor: "#c0705a !important" as any, background: "#fff8f6" },
  select: { appearance: "none" as const, cursor: "pointer" },
  errorMsg: {
    fontFamily: "'DM Sans', sans-serif", fontSize: "0.75rem", color: "#c0705a",
  ...
  agreeText: {
    fontFamily: "'DM Sans', sans-serif", fontSize: "0.83rem", color: "#5a4070", lineHeight: 1.5,
  },
  ...
  submitBtn: {
    ...
    fontWeight: 700, letterSpacing: "0.1em", color: "#fff", border: "none",
    borderRadius: 100, padding: "16px 24px", cursor: "pointer",
    background: NAVY, boxShadow: "0 4px 20px rgba(26,10,46,0.25)",
  ...
  successTitle: {
    ...
    fontWeight: 500, color: NAVY, marginBottom: 12,
  },
  successText: {
    fontFamily: "'DM Sans', sans-serif", fontSize: "0.92rem", color: "#5a4070",

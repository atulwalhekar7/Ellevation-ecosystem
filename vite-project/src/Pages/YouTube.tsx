...
const features = [
  ...
  {
    id: 3,
    title: "Founder messages and community highlights",
    description:
      "This section is intentionally static now and structured to support richer content later.",
  },
];
...
export default function StorytellingSection() {
  ...
  return (
    ...
    fontFamily: "'Cormorant Garamond', serif",
            ...
            >
              Storytelling for a community that is becoming more whole, visible, and equipped.
            </h1>
            ...
            >
              The YouTube experience can become a home for conversations, teachings, event recaps,
              member spotlights, and transformational stories.
            </p>
